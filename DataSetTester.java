...
public class DataSetTester {
	   ...
	   public static void main(String[] args)
	   {
	       ...
	       BankAccount max = (BankAccount) bankData.getMaximum();
	       ...
	       BaseballPlayer maxA = (BaseballPlayer) battingAvgData.getMaximum();
	       System.out.println("Highest batting average: " + maxA.getBattingAverage() + " " + maxA.getName() + " of the "
	               + maxA.getTeam());
